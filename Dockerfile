...
COPY src /usr/src/undp_png/
WORKDIR /usr/src/undp_png
...
RUN chmod +x /usr/src/undp_png/tasks.py \
    && chmod +x /usr/src/undp_png/entrypoint.sh
...
# ENTRYPOINT /usr/src/undp_png/entrypoint.sh
